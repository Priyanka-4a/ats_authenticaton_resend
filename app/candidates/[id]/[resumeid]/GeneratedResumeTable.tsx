...
interface Generated_Resume {
    ...
    uploadedAt: string;
    resumeId: number;
    generatedATSScores: Generated_ATS_Score[]; // Nested scores in each generated resume
}
        ...
        <div>
            ...
            <table className="min-w-full bg-white border border-gray-200 rounded-lg shadow-sm">
                ...
                <tbody>
                    {candidate.generatedResumes.map((resume, index) => {
                        // Access the first ATS score summary and score for display
            ...
            {showJobDescription !== null && (
                <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50">
                    <div className="bg-white p-4 w-[820px] h-[400px] overflow-y-scroll rounded-xl shadow-lg relative">
                        <a
                            href={candidate.generatedResumes[showJobDescription]?.ResumefileUrl}
                            download
